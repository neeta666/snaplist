  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, rgba(255,255,255,0.9) 1.5px, transparent 1.7px)",
          backgroundSize: "18px 18px",
        }}
      />
      <div
      ...
      <div className="relative flex items-center gap-2.5 md:gap-3">
        ...
        <img
          src={wordmark}
          alt="SnapList"
          className="h-12 translate-y-0.5 md:h-[4.5rem] md:translate-y-1"
        />
      </div>
      ...
      <div className="relative mt-5 md:mt-8">
        ...
        <p
          className="mt-3 max-w-[19rem] text-sm leading-relaxed md:mt-4 md:max-w-none md:whitespace-nowrap md:leading-normal"
          style={{ color: "#4B3F67" }}
        >
      ...
      <div className="relative mt-10 hidden flex-1 md:block">
        <div className="relative h-full w-[720px] origin-top-left lg:scale-[0.68] xl:scale-[0.82] 2xl:scale-100">
        <div
