...
export default function ThemeToggle({ menuItem = false, onThemeChange }) {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-brand bg-surface text-ink-muted shadow-sm transition-colors hover:text-brand"
      aria-label={isDark ? "Switch to light mode" : "Switch to dark mode"}
